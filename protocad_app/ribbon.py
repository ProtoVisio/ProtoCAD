...
PART_TAB = Tab("part", "Элементы", [
    ...
    Group("Добавление", [
        ...
        Tool("part.sweep", "По траектории", "sweep",
             "Протянуть профиль вдоль траектории — второго эскиза"),
        Tool("part.loft", "По сечениям", "loft",
             "Тело через несколько сечений по порядку"),
        Tool("part.helix", "Спираль", "helix",
             "Профиль по винтовой линии вокруг оси: пружина, виток"),
    ]),
    Group("Удаление", [
        ...
        Tool("part.sweep_cut", "Вырез по траектории", "sweep_cut",
             "Вырезать профилем, протянутым вдоль траектории: канавка, канал"),
        Tool("part.loft_cut", "Вырез по сечениям", "loft_cut",
             "Вырезать телом через несколько сечений"),
        Tool("part.helix_cut", "Вырез по спирали", "helix_cut",
             "Вырезать профилем по винтовой линии: резьба, винтовая канавка"),
    ]),
    Group("Обработка", [
